...
%% To make customize author list in Creative Common license, uncomment and customize the next line
%\def\authorname{Giuseppe Bandiera, Oriol Romani Picas, Wataru Hariya, Hiroshi Tokuda, Koji Oishi and Xavier Serra} 
...
The analysis of goodness in instrumental sounds is difficult due to its own subjectivity. We tried to address this issue in a previous work [1] by defining a set of sound attributes and asking a group of music experts to record good and bad examples for each one of this attributes. Then the definition of goodness was treated as a classification problem. The outcome of this project is a mobile phone application (Cortosia) that gives a 0 to 10 score of sounds in real-time. This score was computed considering the distribution of the features values in the classification step. During the process of building the app we realised that we could improve the scores, regarding their correlation with the perceptual sound goodness, by having learning data for a range of different goodness levels rather than good or bad examples. The task of labeling sounds this way can be so time consuming. Besides, to have data that could lead to a generalisable solution a lot of annotations from different people are needed. Considering this, we think we can take advantage of web technologies to create a community that provide us the content and the annotations to explore goodness analysis.  
%
